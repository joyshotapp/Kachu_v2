...
class Settings(BaseSettings):
    ...
    IDLE_BRIEF_REFRESH_ENABLED: bool = True
    IDLE_BRIEF_REFRESH_RUN_ON_STARTUP: bool = True
    IDLE_BRIEF_REFRESH_INTERVAL_SECONDS: int = 300
    IDLE_BRIEF_REFRESH_IDLE_SECONDS: int = 300
