...
_INDUSTRY_KEYWORDS: dict[str, tuple[str, ...]] = {
    "restaurant": ("restaurant", "餐廳", "小吃", "便當", "早餐", "火鍋", "餐飲", "麵店", "飲料店"),
    "cafe": ("cafe", "coffee", "咖啡", "咖啡廳", "甜點", "下午茶"),
    "beauty": ("beauty", "salon", "spa", "美甲", "美睫", "美容", "沙龍", "髮廊", "護膚", "美業"),
    "retail": ("retail", "shop", "store", "零售", "選物", "服飾", "電商", "網拍", "門市", "商品"),
}
